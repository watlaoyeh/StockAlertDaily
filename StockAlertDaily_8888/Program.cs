...
namespace StockAlertDaily_8888
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            mail.Subject = "Stock Alert New Algorithm (Sort By RecentPricePercentageChange) -  " + DateTime.Now.AddDays(1).ToString("yyyy-MM-dd");
            ...
            smtp.Port = 587;
            smtp.Credentials = new System.Net.NetworkCredential("liausheauchang@gmail.com", "abracadabra*90");
